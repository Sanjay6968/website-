...
export default function Akar200Downloads() {
  ...
  return (
    <>
      <NextSeo
        title="AKAR 200 | Downloads"
        description="Download the Mekuva Slicer and other resources for the AKAR 200 3D printer."
        openGraph={{
          title: "AKAR 200 | Downloads",
          description: "Download the Mekuva Slicer and other resources for the AKAR 200 3D printer.",
          url: "https://mekuva.com/akar200-downloads",
          images: [
            {
              url: "https://mekuva.com/images/akar200-downloads.jpg",
              width: 1200,
              height: 630,
              alt: "AKAR 200 | Downloads",
            },
          ],
        }}
      />
      <Page title="AKAR 200 | Downloads">
        <Container>
          <Wrapper>
